      ...
      <div className="pt-[72px] md:pt-12 px-6 md:px-12 max-w-5xl mx-auto w-full flex flex-col gap-5">
        <div className="hidden md:flex items-center mb-[-0.5rem]">
          <button
            ...
            className="flex items-center text-primary font-label-md hover:underline"
          >
        ...
        <section className="grid grid-cols-2 md:grid-cols-4 gap-4 w-full">
          <div className="col-span-2 md:col-span-2 bg-gradient-to-br from-[#E3F8D8] to-[#C1F0AE] dark:from-[#1a2d12] dark:to-[#2d4a1f] rounded-2xl p-6 text-gray-900 dark:text-gray-100 shadow-[0_4px_24px_rgba(0,0,0,0.06)] relative overflow-hidden flex flex-col gap-4">
            <div className="absolute top-0 right-0 w-32 h-32 bg-white/40 dark:bg-white/5 rounded-full blur-2xl -mr-10 -mt-10 pointer-events-none"></div>

            <header className="flex flex-col relative z-10 w-full gap-1">
              <div className="bg-white/60 dark:bg-[#3d672a] text-[#42812A] dark:text-[#aee098] w-fit px-2.5 py-0.5 rounded-full font-label-sm backdrop-blur-sm mb-1">
                最新成绩
              </div>
              <h4 className="font-headline-sm font-bold leading-snug w-full pr-4">
                2023-2024学年秋季期中统测 - 数学
              </h4>

              <div className="flex justify-between items-end w-full mt-1">
                <div className="font-label-md text-gray-700 dark:text-gray-300 flex items-center gap-1 pb-1">
                  <Calendar className="w-3.5 h-3.5 shrink-0" /> 2023年11月15日
                </div>
                <div className="flex items-baseline gap-1 shrink-0">
                  <span className="font-display-lg text-gray-900 dark:text-gray-100 leading-none">
                    96
                  </span>
                  <span className="font-body-md text-gray-700 dark:text-gray-300">
                    / 100
                  </span>
                </div>
              </div>
            ...
            <div className="bg-white/40 dark:bg-black/20 backdrop-blur-md rounded-xl p-4 flex gap-3 items-start border border-white/50 dark:border-white/10 mt-1 relative z-10">
              <div className="w-8 h-8 shrink-0 rounded-full bg-white/60 dark:bg-black/30 flex items-center justify-center shadow-sm -mt-0.5">
                <Quote className="w-4 h-4 text-[#42812A] dark:text-[#aee098] fill-[#42812A] dark:fill-[#aee098] relative" />
              </div>
              <p className="font-body-md text-gray-800 dark:text-gray-200 leading-relaxed text-sm">
        ...
        <section className="flex flex-col gap-6">
          <h3 className="font-headline-sm text-on-surface mb-2 px-1">
            历史记录
          </h3>
          ...
          <article className="bg-surface-container-lowest rounded-2xl p-margin-card shadow-[0_4px_24px_rgba(0,0,0,0.03)] flex flex-col gap-5 border-[0.5px] border-surface-variant/30 relative overflow-hidden group">
            ...
            <div className="flex items-end gap-3 pl-2">
              ...
              <span className="font-body-md text-on-surface-variant pb-1">
                / 150
              </span>
            </div>
